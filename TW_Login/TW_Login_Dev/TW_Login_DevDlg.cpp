...
#include "stdafx.h"
#include "TW_Login_Dev.h"
#include "TW_Login_DevDlg.h"
...
CTW_Login_DevDlg::CTW_Login_DevDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CTW_Login_DevDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CTW_Login_DevDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CTW_Login_DevDlg, CDialog)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_CTLCOLOR()
	ON_WM_SETCURSOR()
...
BOOL CTW_Login_DevDlg::OnInitDialog()
{
...
HCURSOR CTW_Login_DevDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

BOOL CTW_Login_DevDlg::DrawRect(CPaintDC *dc)
{
#ifdef DEVELOPERS
...
BOOL CTW_Login_DevDlg::CreateItem(CPaintDC *dc)
{
#ifdef DEVELOPERS
...
BOOL CTW_Login_DevDlg::GetStringWidth(CPaintDC *dc)
{
...
Bitmap *pBitmap;
BOOL CTW_Login_DevDlg::DrawImage(CPaintDC *dc)
{
	///*
...
BOOL CTW_Login_DevDlg::EncryptAndSavedLoginInfo(void)
{
	//Encrypt();
...
BOOL CTW_Login_DevDlg::PreTranslateMessage(MSG* pMsg)
{
...
HBRUSH CTW_Login_DevDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
BOOL CTW_Login_DevDlg::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message)
{
...
void CTW_Login_DevDlg::OnStaticTopRemoteLink(void)
{
...
// 웹 탐색
void CTW_Login_DevDlg::NavigateWeb()
{
...
CString CTW_Login_DevDlg::SaveLoginInfoCreated(void)
{
...
BOOL CTW_Login_DevDlg::LoginInfoParsing(CString cstrBuffer)
{
	//CString cstrBuffer = TEXT("{\"brand_infos\":[{\"brand_id\":\"gongcha316\", \"password\":\"17041\", \"save_toggle\":1}]}");
...
void CTW_Login_DevDlg::OnDestroy()
{
	CDialog::OnDestroy();
...
BOOL CTW_Login_DevDlg::ReadAndDecrypt(void)
{
...
int CTW_Login_DevDlg::Encrypt(void)
{
	int result = 0;
...
int CTW_Login_DevDlg::Decrypt(void)
{
	int result = 0;
